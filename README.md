...
- **Навигация по ролям**: пользователи с несколькими ролями могут переходить между оценкой работ и просмотром результатов через меню
...
Подробная структура таблиц: [docs/database-schema.md](docs/database-schema.md)
...
└── frontend/
    ...
    └── app/
        ...
        └── src/
            ...
            ├── components/
            │   └── AppHeader.vue   # Шапка с меню, ролью, навигацией по разделам
            └── views/
